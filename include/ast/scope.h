...
namespace stride::ast
{
    ...
    public:
        ...
        const std::string& get_internal_name() const { return this->_internal_name.empty() ? _symbol.value : _internal_name; }
    };
    ...
    public:
         ...
         */
        void try_define_global_symbol(const SourceFile& source, const Token& reference_token, const Symbol& symbol, SymbolType symbol_type, const std::string& internal_name = "") const;
         ...
         */
        void try_define_scoped_symbol(const SourceFile& source, const Token& token, const Symbol& symbol, SymbolType symbol_type, const std::string& internal_name = "") const;
