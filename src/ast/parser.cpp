...
{
    auto scope_global = Scope(ScopeType::GLOBAL);
...
std::unique_ptr<IAstNode> stride::ast::parse_next_statement(Scope& scope, TokenSet& set)
{
...
std::unique_ptr<AstBlock> stride::ast::parse_sequential(Scope& scope, TokenSet& set)
{
