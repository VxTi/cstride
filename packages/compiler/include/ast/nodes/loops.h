...
namespace stride::ast
{
    ...
    std::unique_ptr<AstLoop> parse_for_loop_statement(const std::shared_ptr<symbol_registry>& scope, TokenSet& set);

    std::unique_ptr<AstLoop> parse_while_loop_statement(const std::shared_ptr<symbol_registry>& scope, TokenSet& set);
}
